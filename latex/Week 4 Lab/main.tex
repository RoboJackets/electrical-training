...
you an example of a working Board Layout like in Figure 1.
...
smaller or the same size as the Arduino Uno board like the example on Figure 3. For that, you can also use
